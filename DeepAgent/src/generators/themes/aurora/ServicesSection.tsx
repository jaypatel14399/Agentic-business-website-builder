      ...
      <div className="container mx-auto max-w-[var(--theme-maxWidth)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <article
              key={index}
              className="rounded-[var(--theme-borderRadius)] border border-[var(--theme-border)] bg-[var(--theme-backgroundAlt)] p-6 shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden"
            >
              {imageUrls[index] && (

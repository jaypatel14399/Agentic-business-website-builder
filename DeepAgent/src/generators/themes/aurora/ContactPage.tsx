        ...
        <div className="container mx-auto max-w-[var(--theme-maxWidth)]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="rounded-[var(--theme-borderRadius)] border border-[var(--theme-border)] bg-[var(--theme-backgroundAlt)] p-6">
                <ContactForm />
              </div>
            </div>
            <div>
                ...
                {c.phone_display && c.phone_display !== 'N/A' && (
                  <div className="rounded-[var(--theme-borderRadius)] border border-[var(--theme-border)] bg-[var(--theme-backgroundAlt)] p-6">
                    ...
                    <p className="text-[var(--theme-text)]">
                      <a href={`tel:${c.phone_display}`} className="hover:opacity-80 transition-opacity">
                        {c.phone_display}
                      </a>
                    </p>
                  </div>
